...
var jdd = {
    ...
    compare: function (data, data2) {
        ...
        //let data2 = '{"Aidan": {"array": ["Game of Thrones","The Wire"],"string": "some string","int": "2","otherint": 4, "aboolean": "false", "boolean": false,"object": {"foo": "bar"}},"Amy Ryan": ["In Treatment","The Wire"],"Annie Fitzgerald": ["True Blood","Big Love","The Sopranos","Oz"],"Anwan Glover": ["Treme","The Wire"],"Alexander Skarsg?rd": ["Generation Kill","True Blood"],"Alice Farmer": ["The Corner","Oz","The Wire"]}';
        var left = data;//JSON.parse(data);//$('#textarealeft').val());
        var right = data2;//JSON.parse(data2);//$('#textarearight').val());
